...
-- alter orders table
ALTER TABLE orders ADD order_id int;

ALTER table orders ADD order_date date;

ALTER table orders ADD com_id int;

ALTER table orders ADD sales_id int;
